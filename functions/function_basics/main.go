...
// defining a function that has one parameter of type float64 and returns a value of type float64
...
// defining a function that has two parameters of type int and returns two values of type int
func f5(a, b int) (int, int) {
	return a * b, a + b
}

// defining a function that has one parameter of type int and returns a "named parameter"
